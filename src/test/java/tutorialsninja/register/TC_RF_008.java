...
public class TC_RF_008 extends Base{
	...
	public void verifyRegisteringAccountByProvidingMismatchingPasswords() {
		...
		String expectedPasswordError = "Password confirmation does not match password!";
		Assert.assertEquals(driver.findElement(By.xpath("//div[@class=\"text-danger\"]")).getText(), expectedPasswordError);
